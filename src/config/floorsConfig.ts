...
export const floorsConfig: FloorData[] = [
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        type: 'utility',
        description: 'Аудиторія',
        keywords: ['фінанси', 'аудиторія', 'вайфай'],
      },
      {
        id: 'r1-310',
        label: '310',
  ...
  },
  {
    ...
    rooms: [
      ...
      },
      {
        ...
        label: '321',
        type: 'office',
        description: 'Методичний кабінет',
      ...
      },
      {
        ...
        label: '325',
        type: 'classroom',
        description: 'Кабінет кримінального права',
      ...
      },
      {
        ...
        label: '327',
        type: 'classroom',
        description: 'Аудиторія 327',
        panoramaSceneId: 'room_327',
      },
      {
        id: 'r2-329',
        label: '329',
      ...
      // --- Нижній ряд (312 - 324) ---
      {
        ...
        label: '312',
        type: 'classroom',
        description: 'Лабораторія фізики',
      ...
      },
      {
        ...
        label: '320',
        type: 'classroom',
        description: 'Кабінет країнознавства та туризм',
        keywords: ['туризм', 'країнознавство', 'географія'],
      ...
      },
      {
        ...
        label: '322',
        type: 'classroom',
        description: '5 курс (м) ТУРИЗМ',
        keywords: ['туризм', '5 курс туризм'],
      ...
      },
      {
        ...
        label: '324',
        type: 'classroom',
        description: 'курс ТУРИЗМ',
        keywords: ['туризм', 'курс'],
  ...
  },
  {
    ...
    rooms: [
      // --- Верхній ряд (333 - 349) ---
      {
        ...
        label: '333',
        type: 'classroom',
        description: 'Велика лекційна зала',
      ...
      },
      {
        ...
        type: 'classroom',
        description: 'Аудиторія',
        panoramaSceneId: 'room_345',
      },
      {
        id: 'r3-347',
        label: '347',
        type: 'utility',
        description: 'Навчальна частина / Бухгалтерія',
        panoramaSceneId: 'room_347',
        note: 'З 12 по 13 годину - обідня перерва',
      },
      {
        id: 'r3-349',
        label: '349',
        type: 'classroom',
        description: "Комп'ютерний клас №3",
      ...
      // --- Нижній ряд (326 - 342) ---
      {
        ...
        label: '326',
        type: 'classroom',
        description: "Комп'ютерний клас №2",
        keywords: ['pc', 'інформатика', 'програмування'],
        panoramaSceneId: 'room_326',
      },
      {
        id: 'r3-328',
        label: '328',
      ...
      },
      {
        ...
        label: '338',
        type: 'classroom',
        description: 'Директорське приміщення',
        note: 'Вхід тільки для директора та його заступників!',
      },
      {
        id: 'r3-340',
        label: '340',
        type: 'classroom',
        description: 'Навчально-методичний відділ',
        keywords: ['методист', 'навчально-методичний відділ', 'розклад'],
