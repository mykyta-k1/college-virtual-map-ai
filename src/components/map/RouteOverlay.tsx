...
export const RouteOverlay: React.FC<RouteOverlayProps> = ({
    ...
    const pathData = useMemo(() => {
        ...
        return floorPath.map((node, index) => {
    ...
    return (
        ...
        >
            ...
            {showStartMarker && (
                <circle cx={startNode.x} cy={startNode.y} r="8" fill="#3b82f6" stroke="white" strokeWidth="2" />
            )}
            ...
            {transitionData && (
                ...
                >
                    ...
                    />
                    {/* Точка на маршруті */}
                    <circle cx={transitionData.node.x} cy={transitionData.node.y} r="6" fill="#8b5cf6" stroke="white" strokeWidth="2" />
                </g>
            )}
        </svg>
    );
