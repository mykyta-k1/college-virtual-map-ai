...
import { getSVGClickCoordinates } from './mapUtils';
...
export default function MapViewer({
  ...
  const handleMapClick = (e: React.MouseEvent) => {
    // --- LOG COORDINATES (Utility) ---
    // Get the actual SVG element. react-inlinesvg renders an <svg> tag as the root.
    const svgElement = e.currentTarget as unknown as SVGSVGElement;
    const coords = getSVGClickCoordinates(e, svgElement);
    if (coords) {
